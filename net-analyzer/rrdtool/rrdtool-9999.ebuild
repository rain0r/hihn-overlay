...
inherit autotools eutils perl-module distutils-r1 flag-o-matic multilib git-r3

DESCRIPTION="A system to store and display time-series data"
HOMEPAGE="http://oss.oetiker.ch/rrdtool/"
#SRC_URI="http://oss.oetiker.ch/rrdtool/pub/${P/_/-}.tar.gz"
#EGIT_COMMIT=v1.5.0-rc2
EGIT_REPO_URI=https://github.com/oetiker/rrdtool-1.x.git
